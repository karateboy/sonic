      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-item-dropdown text="Configuration" right>
            <b-dropdown-item @click="updateSetting" to="/setting">Setting</b-dropdown-item>
            <b-dropdown-item @click="updateBackground" to="/background">Background</b-dropdown-item>
            <b-dropdown-item href="#">Alarm</b-dropdown-item>
          </b-nav-item-dropdown>
        </b-navbar-nav>
      </b-collapse>
    </b-navbar>
    <b-modal id="modal" :title="modalTitle" header-bg-variant="info" hide-footer>
